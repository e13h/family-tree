...
class Person:
    ...
    def __init__(self, first_name: str, last_name: str, birthday: str, anniversary: str = None):
        self.first_name = first_name
        self.last_name = last_name
        self.birthday = datetime.strptime(birthday, "%Y-%m-%d")
        self.anniversary = datetime.strptime(anniversary, "%Y-%m-%d") if anniversary else None
